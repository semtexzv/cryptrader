...
\hline
\multirow{2}{*}{Configuration} & \multicolumn{3}{c|}{Node configuration}                                                                                  & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Database \\ configuration\end{tabular}} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Core\\ configuration\end{tabular}} & \multicolumn{2}{c|}{Worker configuration}                                                           \\ \cline{2-4} \cline{7-8}
& \#                 & Type                                                                       & Cost                   &                                                                                    &                                                                               & \#                 & Type                                                                           \\ \hline
C1.0                           & \multirow{2}{*}{2} & \multirow{5}{*}{\begin{tabular}[c]{@{}c@{}}2 CPU \\ 2 GB ram\end{tabular}} & \multirow{2}{*}{\$40}  & \begin{tabular}[c]{@{}c@{}}1 CPU\\ 0.5GB RAM\end{tabular}                          & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}200 mCPU\\ 120 MB\end{tabular}}    & 2                  & \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}150 mCPU\\  80 MB RAM\end{tabular}} \\ \cline{1-1} \cline{5-5} \cline{7-7}
C1.5                           &                    &                                                                            &                        & \begin{tabular}[c]{@{}c@{}}1.5 CPU\\ 1G RAM\end{tabular}                           &                                                                               & 3                  &                                                                                \\ \cline{1-2} \cline{4-7}
C2.0                           & \multirow{3}{*}{4} &                                                                            & \multirow{3}{*}{\$80}  & \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}1.5 CPU\\ 1.5 GB RAM\end{tabular}}      & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}200 mCPU\\ 120 MB\end{tabular}}    & \multirow{5}{*}{8} &                                                                                \\ \cline{1-1} \cline{8-8}
C2.1                           &                    &                                                                            &                        &                                                                                    &                                                                               &                    & \multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}300 mCPU\\ 150 MB RAM\end{tabular}} \\ \cline{1-1} \cline{6-6}
C2.2                           &                    &                                                                            &                        &                                                                                    & \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}400 mCPU\\ 150 MB\end{tabular}}    &                    &                                                                                \\ \cline{1-5}
\multirow{2}{*}{C3.0}          & 4                  & \begin{tabular}[c]{@{}c@{}}2 CPU\\ 2 GB ram\end{tabular}                   & \multirow{2}{*}{\$120} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}2 CPU\\ 2 GB RAM\end{tabular}}          &                                                                               &                    &                                                                                \\ \cline{2-3}
& 1                  & \begin{tabular}[c]{@{}c@{}}4 CPU\\  8 GB ram\end{tabular}                  &                        &                                                                                    &                                                                               &                    &                                                                                \\ \hline
\end{tabular}
\end{table}
...
Graphs for these stages are below:
\begin{figure}[H]
...
Overall, we regard this choice as a good one. With some updates to the language which should be available soon (Await syntax\todo{footnote})
